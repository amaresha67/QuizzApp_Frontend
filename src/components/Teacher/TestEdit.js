    ...
    async function fetchData() {
      try {
        ...
        result.questions.map((q, index) => {
          updated[index].questionText = q.question;

          updated[index].options[0] = q.option_1;
          updated[index].options[1] = q.option_2;
          updated[index].options[2] = q.option_3;
          updated[index].options[3] = q.option_4;
          updated[index].correctAnswerIndex = parseInt(q.answer);
        });
